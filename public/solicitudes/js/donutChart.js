...
DonutChart = function(_parentElement, _variable, _attrib, _tittle){
...
DonutChart.prototype.wrangleData = function(dataTimeFiltered){
	var vis = this;
	sizeNest = d3.nest()
		.key(function(d){
			return d[vis.attrib];
...
DonutChart.prototype.addLegend = function(){
	...
	var legendArray = [
		{label: "Si", color: vis.color("1")},
		{label: "No", color: vis.color("0")},
	]
